 ...
 */
final class Version20240712093244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE editor DROP books');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE author ADD books LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\'');
        $this->addSql('ALTER TABLE book CHANGE editor_id editor_id INT NOT NULL');
        $this->addSql('ALTER TABLE editor ADD books LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\'');
    }
}
