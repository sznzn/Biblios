 ...
 */
final class Version20250218145129 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE author ADD books LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
        $this->addSql('ALTER TABLE book ADD authors LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
}
